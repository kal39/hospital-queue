...
// API Helpers (Exact standards preserved)
...
export default function ReceptionPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-[#002b49] font-sans flex flex-col md:flex-row select-none">
      
      {/* ADDED LEFT SIDEBAR NAVIGATION */}
      <aside className="w-full md:w-64 bg-white border-r border-gray-150 p-5 flex flex-col justify-between flex-shrink-0 shadow-xs">
        <div>
          {/* BRAND HEADER */}
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <span className="text-lg font-bold text-[#002b49] block leading-tight">HospitalQueue</span>
              <span className="text-[10px] text-gray-400 font-extrabold uppercase tracking-wider">Clinical Management</span>
            </div>
          </div>
          ...
          <nav aria-label="Sidebar Navigation" className="space-y-1.5">
            <Link 
              href="/admin" 
              className="flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-bold text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-all"
            >
            ...
            <Link 
              href="/reception" 
              className="flex items-center gap-3 px-4 py-3 rounded-2xl text-xs font-bold bg-[#d6e4ff] text-[#0046ad] shadow-2xs transition-all"
            >
              <Users size={18} />
        ...
        <div className="pt-6 border-t border-gray-100 mt-6">
          <Link href="/live-queue" className="block">
            <button className="w-full bg-[#0046ad] hover:bg-[#00347a] text-white py-3 px-4 rounded-2xl font-bold text-xs transition-all flex items-center justify-center gap-2 shadow-md shadow-blue-500/10">
              <UserCheck size={16} />
              Call Next Patient
            </button>
          </Link>
      ...
      {/* MAIN RECEPTION CONTENT AREA (Exact Original Layout Preserved) */}
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-40 w-full bg-white border-b border-gray-150 px-6 py-4 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#0046ad] rounded-xl flex items-center justify-center text-white shadow-md shadow-blue-500/10 md:hidden">
              <Building2 size={20} />
            </div>
            <div>
